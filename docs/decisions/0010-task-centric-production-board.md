...
underlying model is task-based, and there is a real everyday parallel case (hand-tying the _top_
while the _base_ is still being machine-sewn), plus future planning-engine resequencing that opens
