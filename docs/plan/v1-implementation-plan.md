...
3. Customers → 4. Intake → order → runtime-task generation → 5. Task-centric board →
6. Work-order hub + task actions + approvals → 7. Sprint & personal queue → 8. Missing items +
